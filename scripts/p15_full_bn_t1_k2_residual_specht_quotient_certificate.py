...
def write_markdown(summary: ResidualSummary, path: Path) -> None:
    ...
    lines = [
        ...
        "artifacts/certified/P15_FULL_BN_T1_K2_RESIDUAL_SPECHT_QUOTIENT_CERTIFICATE.json",
        "artifacts/certified/P15_FULL_BN_T1_K2_RESIDUAL_SPECHT_QUOTIENT_CERTIFICATE.md",
        "```",
        "",
        "## Boundary",
        "",
