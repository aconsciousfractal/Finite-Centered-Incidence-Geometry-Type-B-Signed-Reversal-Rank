...
def write_markdown(summary: T2Summary, path: Path) -> None:
    ...
    lines += [
        ...
        "artifacts/certified/P15_FULL_BN_T2_K3_QUOTIENT_AND_SIGN_TWIST_CERTIFICATE.json",
        "artifacts/certified/P15_FULL_BN_T2_K3_QUOTIENT_AND_SIGN_TWIST_CERTIFICATE.md",
        "```",
        "",
        "## Boundary",
        "",
